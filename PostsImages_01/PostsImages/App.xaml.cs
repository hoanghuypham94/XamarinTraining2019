...
namespace PostsImages
{
    public partial class App : PrismApplication
    {
        ...
        protected override void RegisterTypes(IContainerRegistry containerRegistry)
        {
            ...
            containerRegistry.RegisterForNavigation<DetailImageMyView, DetailImageMyViewModel>();
            containerRegistry.RegisterForNavigation<GoogleProfilePage, GoogleProfilePageViewModel>();
            containerRegistry.RegisterForNavigation<FacebookProfilePage, FacebookViewModel>();
